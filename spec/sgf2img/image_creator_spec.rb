describe 'ImageCreator' do
  ...
  it "should generate the right command for an empty 3x3 board" do
    command = "montage top_left.gif top_center.gif top_right.gif center_left.gif center_center.gif center_right.gif bottom_left.gif bottom_center.gif bottom_right.gif -tile 3x3 -geometry +0+0 test.gif"
  ...
  it "should generate the right command for a 3x3 board with some stones" do
    command = "montage black.gif top_center.gif top_right.gif center_left.gif white.gif center_right.gif bottom_left.gif bottom_center.gif bottom_right.gif -tile 3x3 -geometry +0+0 test.gif"
